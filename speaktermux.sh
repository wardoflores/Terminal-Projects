...
file_path=~/storage/shared/repository/Obsidian-Personal-Vault/03\ Record/$year/$month/$current_date.md

# Ensure the directory exists
mkdir -p ~/storage/shared/repository/Obsidian-Personal-Vault/03\ Record/$year/$month
